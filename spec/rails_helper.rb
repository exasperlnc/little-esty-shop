def test_data
  ...
  @merchant_1 = Merchant.create!(name: "Carl's Shop")
  @merchant_2 = Merchant.create!(name: "Big I Industries")
  @merchant_3 = Merchant.create!(name: "Backyard Finds")
  @merchant_4 = Merchant.create!(name: "Gorgonzola Time")
  @merchant_5 = Merchant.create!(name: "Afred's Aliminum and other Curiosities")

  @item_1 = Item.create!(name: "Crocs", description: "Description_1", unit_price: 100, merchant: @merchant_1)
  @item_2 = Item.create!(name: "Lemonade", description: "Description_2", unit_price: 15000, merchant: @merchant_2)
  @item_3 = Item.create!(name: "Cowboy Hat", description: "Description_3", unit_price: 50000, merchant: @merchant_3)
  @item_4 = Item.create!(name: "Protein Powder", description: "Description_4", unit_price: 20000, merchant: @merchant_4)
  @item_5 = Item.create!(name: "Pencil", description: "Description_5", unit_price: 25000, merchant: @merchant_5)
  @item_6 = Item.create!(name: "Bedside Table", description: "Description_6", unit_price: 50000, merchant: @merchant_4)
  @item_7 = Item.create!(name: "Ergonomic Keyboard", description: "Description_7", unit_price: 10000, merchant: @merchant_3)
  @item_8 = Item.create!(name: "Coffee Grounds", description: "Description_8", unit_price: 100000, merchant: @merchant_5)
  @item_9 = Item.create!(name: "Tortilla", description: "Description_9", unit_price: 56465, merchant: @merchant_1)
  @item_10 = Item.create!(name: "Organic Trashcan", description: "Description_10", unit_price: 54134, merchant: @merchant_2)
